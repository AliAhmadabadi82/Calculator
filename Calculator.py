...
#function
def about():
    messagebox.showinfo('About',"\n \n \n   Made By Ali Ahmadabadi And Mahdiyar Hasanzadeh   \n Website: https://aliahmadabadi82.github.io . NOTICE: IF YOU HAVE QUESTIONS ASK IN GUTHUB! LISTED IN MY WEBSITE!\n \n")
...
ac = PhotoImage(file = r"C:\Users\Asus\Pictures\images\ac.png")
...
clear = PhotoImage(file = r"C:\Users\Asus\Pictures\images\clear.png")
...
expan_btn = PhotoImage(file = r"C:\Users\Asus\Pictures\images\expan_btn.png")
...
divide = PhotoImage(file = r"C:\Users\Asus\Pictures\images\divide.png")
...
seven = PhotoImage(file = r"C:\Users\Asus\Pictures\images\seven.png")
...
eight = PhotoImage(file = r"C:\Users\Asus\Pictures\images\eight.png")
...
nine = PhotoImage(file = r"C:\Users\Asus\Pictures\images\nine.png")
...
multi = PhotoImage(file = r"C:\Users\Asus\Pictures\images\multi.png")
...
four = PhotoImage(file = r"C:\Users\Asus\Pictures\images\four.png")
...
five = PhotoImage(file = r"C:\Users\Asus\Pictures\images\five.png")
...
six = PhotoImage(file = r"C:\Users\Asus\Pictures\images\six.png")
...
minus = PhotoImage(file = r"C:\Users\Asus\Pictures\images\minus.png")
...
one = PhotoImage(file = r"C:\Users\Asus\Pictures\images\one.png")
...
two = PhotoImage(file = r"C:\Users\Asus\Pictures\images\two.png")
...
three = PhotoImage(file = r"C:\Users\Asus\Pictures\images\three.png")
...
plus = PhotoImage(file = r"C:\Users\Asus\Pictures\images\plus.png")
...
zero = PhotoImage(file = r"C:\Users\Asus\Pictures\images\0.png")
...
point = PhotoImage(file = r"C:\Users\Asus\Pictures\images\point.png")
...
equal = PhotoImage(file = r"C:\Users\Asus\Pictures\images\equal.png")
...
bracket1 = PhotoImage(file = r"C:\Users\Asus\Pictures\images\bracket1.png")
...
bracket2 = PhotoImage(file = r"C:\Users\Asus\Pictures\images\bracket2.png")
...
pie=3.14
pi = PhotoImage(file = r"C:\Users\Asus\Pictures\images\pi.png")
...
#Copy Paste
eie = 2.71
ee = PhotoImage(file = r"C:\Users\Asus\Pictures\images\eie.png")
...
#Copy Paste
sin_btn = PhotoImage(file = r"C:\Users\Asus\Pictures\images\sin_btn.png")
...
#Copy Paste
cos_btn = PhotoImage(file = r"C:\Users\Asus\Pictures\images\cos_btn.png")
...
#Copy Paste
tan_btn = PhotoImage(file = r"C:\Users\Asus\Pictures\images\tan_btn.png")
...
#Copy Paste
log_btn = PhotoImage(file = r"C:\Users\Asus\Pictures\images\log_btn.png")
...
expan = PhotoImage(file = r"C:\Users\Asus\Pictures\images\expand.png")
expanimage = expan.subsample(4,4)
expan = Label(window, text="pi", fg="black",image=expanimage, bg="black").pack(side=BOTTOM)

window.iconbitmap(r"C:\Users\Asus\Pictures\images\icon.ico")
window.config(bg="black",menu=menubar)
window.mainloop()
#OK THATS IT BYEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE!!!!!!!! (Ali And Mahdiyar Finally Putting The Last Symbol In This Code, Which Is () 😀)